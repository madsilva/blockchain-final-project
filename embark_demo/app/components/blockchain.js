...
class Blockchain extends React.Component {
  ...
  getValue(e) {
    ...
    ContractFactory.methods.getAccount('0xd084415e680cb53Cf7A28aca167Dbf7A0e6d809D').call().then(_value => this.setState({ testAdr: _value }));
    console.log(this.state.testAdr);
    var newUser = UserContract.clone();
    console.log(newUser);
    newUser.options.address = this.state.testAdr;
    var res = newUser.methods.getName().call().then(_value => this.setState({ testVal: _value }));
    console.log(res);
